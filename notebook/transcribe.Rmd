...
```{python}
# Test band pass
convert_audio('../uploaded_file/Sampel6.wav', '../uploaded_file/coverted_Sampel6.wav')
```
...
def test_band_pass():
    ...
    audio, sr = librosa.load("../uploaded_file/Sampel6.wav", sr=None)
    
    filtered_audio = butter_bandpass_filter(audio, lowcut, highcut, sr)
    librosa.output.write_wav("../uploaded_file/filtered_Sampel6.wav", filtered_audio, sr, norm=False)
...
audio, sr = librosa.load("../uploaded_file/filtered_Sampel6.wav", sr=None)

# Pengambilan clip noise dari audio
noise_audio = getNoise(audio, 86.901, 89.586, sr)

# Proses noise reduction
reduced_audio = removeNoise(audio, noise_audio)

# librosa.output.write_wav("../uploaded_file/reduced_Sampel6.wav", reduced_audio, sr)
```
